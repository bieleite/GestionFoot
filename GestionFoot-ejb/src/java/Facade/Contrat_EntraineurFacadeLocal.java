...
public interface Contrat_EntraineurFacadeLocal {
    ...
    Contrat_Entraineur rechercheContrat_EntraineurParEntraineur(Entraineur ent);
    ...
    Contrat_Entraineur rechercheEquipeParContrat_EntraineurActifParEntraineur(Entraineur ent);
}
