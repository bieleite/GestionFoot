<%-- 
    Document   : AfficherFautesParJouer
    Created on : 29/11/2018, 23:49:33
    Author     : gabrielleite
--%>
...
<html>
    <head>
        ...
        <jsp:useBean id="listeFautesParJouer" scope="request" class="java.util.List"></jsp:useBean>
    ...
    <body>
        ...
        <table border width=50%>
            ...
            <% List<Fautes> lesFautes=listeFautesParJouer;
